...
internal class TemplateValues : TemplateValuesBase
{
    ...
    public string DD_CATEGORIES_VALUES_TABLE { get => tokens[nameof(DD_CATEGORIES_VALUES_TABLE)]; init => tokens[nameof(DD_CATEGORIES_VALUES_TABLE)] = value; }
    public string DD_STATUS_VALUES_TABLE { get => tokens[nameof(DD_STATUS_VALUES_TABLE)]; init => tokens[nameof(DD_STATUS_VALUES_TABLE)] = value; }
    public string DD_OBJECTS_STATUS_TABLE { get => tokens[nameof(DD_OBJECTS_STATUS_TABLE)]; init => tokens[nameof(DD_OBJECTS_STATUS_TABLE)] = value; }
    public string DD_OBJECTS_TABLE { get => tokens[nameof(DD_OBJECTS_TABLE)]; init => tokens[nameof(DD_OBJECTS_TABLE)] = value; }
    public string SCHEMA_NAME { get => tokens[nameof(SCHEMA_NAME)]; init => tokens[nameof(SCHEMA_NAME)] = value; }
