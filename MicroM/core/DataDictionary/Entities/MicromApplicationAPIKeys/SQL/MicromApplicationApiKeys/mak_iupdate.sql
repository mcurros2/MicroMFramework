create or alter proc mak_iupdate
...
begin try
    ...
    select  @cu=dt_lu
    from    [microm_application_api_keys] with (rowlock, holdlock, updlock)
    ...
    begin
        ...
        insert  [microm_application_api_keys]
        values
            (
            @application_id
            , @api_key_id
    ...
    if @change_secret = 1
    begin
        update  [microm_application_api_keys]
