...
{
    public FileStoreStatusDef() : base("fsts", nameof(FileStoreStatus), schemaName: DataDefaults.DataDictionarySchema) { SQLCreationOptions = SQLCreationOptionsMetadata.WithIUpdateAndIDrop; }
