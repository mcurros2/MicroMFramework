...
namespace MicroM.DataDictionary
{
    ...
    public class EntityGeneratedCode : Entity<EntityGeneratedCodeDef>
    {
        ...
        public override async Task<bool> GetData(CancellationToken ct, MicroMOptions? options = null, Dictionary<string, object>? server_claims = null, IMicroMWebAPI? api = null, string? api_app_id = null)
        {
            ...
            var assemblies = api.GetAllAPPAssemblies(app_id);
