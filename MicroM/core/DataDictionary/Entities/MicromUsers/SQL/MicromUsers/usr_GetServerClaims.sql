create or alter proc [dbo].usr_GetServerClaims @username varchar(255) as
...
-- The keys format is:
--- The column name that will match the entity column to be overrided, for example c_user_id
--- The value that will be used to override the entity column, for example the c_user_id.value
...
-- 3. The keys will be cached for the session duration, including refreshs
