create or alter proc [dbo].apa_iupdateAssembly
...
begin try
	...
	begin
		...
		begin
			...
			exec [dbo].apa_idrop @application_id, @assembly_id, @result out, @msg out
			...
			begin
				...
				exec [dbo].eas_idrop @assembly_id, @result out, @msg out
	...
	begin
		...
		exec [dbo].eas_iupdate null, @assembly_path, null, @webusr, @result out, @msg out
		...
		set	 @result=-1
		exec [dbo].apa_iupdate @application_id, @msg, @order, null, @webusr, @result out, @msg out    
	...
	begin
		...
		exec [dbo].eas_iupdate @assembly_id, @assembly_path, @i_lu, @webusr, @result out, @msg out
		...
		set	 @result=-1
		exec [dbo].apa_iupdate @application_id, @assembly_id, @order, @i_lu, @webusr, @result out, @msg out    
