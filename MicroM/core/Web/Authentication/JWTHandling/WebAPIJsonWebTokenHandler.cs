...
namespace MicroM.Web.Authentication
{
    ...
    public class WebAPIJsonWebTokenHandler(
        IOptions<MicroMOptions> options, IMicroMAppConfiguration app_config, IHttpContextAccessor http_context, ILogger<WebAPIJsonWebTokenHandler> logger
        ) : JsonWebTokenHandler
    {
        ...
        private TokenValidationParameters GetValidationParametersFromContext()
        {
            ...
            {
                ApplicationOption? app = app_config.GetAppConfiguration(app_id, CancellationToken.None);
