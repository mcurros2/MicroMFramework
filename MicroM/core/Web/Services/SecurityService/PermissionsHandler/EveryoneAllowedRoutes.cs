    ...
    public static bool IsEveryoneAllowedRoute(string base_path, string app_id, string route_path)
    {
        if (route_path.IsIn(
                [
                    ...
                    $"/{base_path}/{app_id}/ent/{nameof(FileStoreClient)}/delete",
                    $"/{base_path}/{app_id}/ent/{nameof(CategoriesValues)}/view/{nameof(CategoriesValuesDef.cav_brwStandard)}",
                    $"/{base_path}/{app_id}/ent/{nameof(FileStoreClient)}/view/{nameof(FileStoreClientDef.fcc_brwFiles)}",
                    $"/{base_path}/{app_id}/ent/{nameof(CategoriesValues)}/viewstream/{nameof(CategoriesValuesDef.cav_brwStandard)}",
                    $"/{base_path}/{app_id}/ent/{nameof(FileStoreClient)}/viewstream/{nameof(FileStoreClientDef.fcc_brwFiles)}",
                    $"/{base_path}/{app_id}/ent/{nameof(MicromUsers)}/procstream/{nameof(MicromUsersDef.usr_GetEnabledMenus)}",
                    $"/{base_path}/{app_id}/ent/{nameof(SystemProcs)}/procstream/{nameof(SystemProcsDef.sys_GetTimeZoneOffset)}"
                ],
