...
public interface IStorageService<T>
{
    ...
    public Task<ResultWithStatus<long, ErrorResult>> StoreFile(IEntityClient ec, ApplicationOption app, FileDetails fileDetails, Stream filestream, CancellationToken ct);
