...
public interface IFileUploadService
{
    ...
    Task<DBStatusResult> DeleteFile(ApplicationOption app, string fileguid, IEntityClient ec, CancellationToken ct);
    Task<FileDetails[]?> GetAllFileDetails(ApplicationOption app, string fileprocess_id, IEntityClient ec, CancellationToken ct);
